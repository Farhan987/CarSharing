...
import FirstFutureReservationComponent from '../../components/firstFutureReservationComponent';
class FirstReservationScreen extends Component {
  state = {tab: true};
  toggleTab = text => {
    ...
    return (
      <View style={styles.container}>
        ...
        {this.state.tab ? (
          ...
          <FirstFutureReservationComponent navigation={this.props.navigation} />
        )}
      </View>
    );
  }
...
export default FirstReservationScreen;
