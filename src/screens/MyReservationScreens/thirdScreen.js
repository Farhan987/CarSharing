...
import {SMALL, EXTRA_LARGE} from '../../theme/font';
import CustomHeader from '../../components/customHeader';
import RenderComponent from '../../components/renderComponent';
import ThirdFutureReservationComponent from '../../components/thirdFutureReservationComponent';
class ThirdReservationScreen extends Component {
  state = {tab: true};
  toggleTab = text => {
    ...
    return (
      <View style={styles.container}>
        ...
        {this.state.tab ? (
          ...
          <ThirdFutureReservationComponent navigation={this.props.navigation} />
        )}
      </View>
    );
  }
...
export default ThirdReservationScreen;
