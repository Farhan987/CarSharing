...
import CarDownModal from '../components/modalComponents/checkOutRealizedComponent2';
class ThirdProfileAutorizarCheckInScreen extends Component {
  state = {
    image: null,
    modalVisible: false,
    modalVisible1: false,
...
export default ThirdProfileAutorizarCheckInScreen;
