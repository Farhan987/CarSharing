...
class ThirdEditProfileScreen extends Component {
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <SecondTextInput
            placeholder={'Nicole Dias Fernandes Ferreira Gonçalves'}
          />
          <View style={{height: 10}} />
...
export default ThirdEditProfileScreen;
